...
namespace Mango.Services.RewardAPI.Messaging
{
    public class AzureServiceBusConsumer : IAzureServiceBusConsumer
    {
        ...
        ServiceBusProcessor _rewardProcessor;
        ...
        public AzureServiceBusConsumer(IConfiguration configuration, RewardService rewardService)
        {
            ...
            orderCreatedTopic = _configuration
            ...
            _rewardProcessor = client
                .CreateProcessor(orderCreatedTopic, orderCreatedRewardSubscription);
        }
        ...
        private async Task OnNewOrderRewardRequestReceived(ProcessMessageEventArgs args)
        {
            ...
            RewardsMessage objMessage = JsonConvert
                .DeserializeObject<RewardsMessage>(body);
            try
            {
